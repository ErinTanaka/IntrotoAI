...
public:
    ...
    MinimaxPlayer* clone();
		...
		void generateSucessorCoordinates(OthelloBoard * b, int** storageArray, char player);
		int utilityFn(OthelloBoard * b);
		int minimaxFunction(OthelloBoard * b, int** succCoors, int lenSuccCoors, char playerChar);
private:
